...
API_ID = int(environ['API_ID', 14417186])
API_HASH = environ['API_HASH', '21731d919d79f78de24bdf1f6ccd6921']
BOT_TOKEN = environ['BOT_TOKEN', '5386524939:AAGyHyUa0yYMrW9PRKs1MlX4lBFhvq3JhM8']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5558249587').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1001670413254')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://LEECH:LEECH@cluster0.tfhutfu.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "LEECH")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MR_LINK_Z')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>↬ File Name:</b><code> {file_name}</code>\n<b>↬ Size:</b> {file_size}\n\n<code>𝗝𝗢𝗜𝗡</code> @MR_LINK_Z <code>𝗙𝗢𝗥 𝗟𝗔𝗧𝗘𝗦𝗧 𝗠𝗢𝗩𝗜𝗘𝗦 𝗔𝗡𝗗 𝗨𝗣𝗗𝗔𝗧𝗘𝗦.!</code>")
